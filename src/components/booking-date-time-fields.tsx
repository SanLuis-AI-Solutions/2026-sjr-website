...
export function BookingDateTimeFields() {
  ...
  return (
    <div className="mt-4 grid gap-4 sm:grid-cols-2">
      <label htmlFor="booking-date-display" className="block text-xs uppercase tracking-[0.2em] text-stone-600">
        Date
      ...
      <label htmlFor="booking-time" className="block text-xs uppercase tracking-[0.2em] text-stone-600">
        Time
        <select
          id="booking-time"
          name="time"
